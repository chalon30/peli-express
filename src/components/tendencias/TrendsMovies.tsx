    ...
    <div className="max-w-7xl mx-auto py-12 px-4 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {movies.map((movie) => (
          <div
            key={movie.id}
            className="flex gap-4 items-start bg-black rounded-lg p-4 shadow-md"
          >
            <img
            ...
            <div className="flex flex-col flex-grow min-w-0">
              <h3 className="text-md font-semibold text-red-500 drop-shadow-[0_0_6px_#ff0000] mb-2 truncate">
                {movie.title}
              </h3>
              <div
                className="
